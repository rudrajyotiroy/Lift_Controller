...
HD_PWD='C:/Users/rudra/OneDrive/Documents/Lift_Controller/Lift_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log door_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source door_controller.tcl
