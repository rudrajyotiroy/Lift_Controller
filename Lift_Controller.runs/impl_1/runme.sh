...
HD_PWD='C:/Users/rudra/OneDrive/Documents/Lift_Controller/Lift_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log door_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source door_controller.tcl -notrace
